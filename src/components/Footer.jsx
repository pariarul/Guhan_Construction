  ...
  return (
    <footer className="bg-slate-50 border-t border-gray-100 text-slate-600">
      ...
      <div className="container mx-auto px-4 sm:px-6 pt-16 pb-12">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4 text-left">
          ...
          <div className="space-y-5">
            ...
            <a
              ...
              className="block text-base sm:text-lg font-extrabold text-slate-900"
            >
              +91 93400 00400
            </a>
            ...
            <a
              ...
              className="block text-xs sm:text-sm md:text-[12px] font-bold text-primary hover:underline break-all"
            >
      ...
      <div className="border-t border-gray-100 py-5 px-4">
        <div className="container mx-auto text-left">
          <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest leading-relaxed">
            © {currentYear} Guhan Homes and Renovations Pvt. Ltd.
          </p>
          <p className="text-[9px] text-slate-900 font-serif italic tracking-widest mt-1">
            Madurai, Tamil Nadu · Premium Luxury Series
          </p>
        </div>
      </div>
    </footer>
